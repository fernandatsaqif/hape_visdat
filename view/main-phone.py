...
st.set_page_config(
    page_title="Real-Time Data Smartphone Pricing",
    page_icon="✅",
    layout="wide",
...
def scatter_price_laptop(count, title, asc):
    ...
    fig = px.scatter(
        ...
        x=clean_price_laptop["brand_name"],
        y=clean_price_laptop["price"],
        title=title,
        color=clean_price_laptop["brand_name"],
        hover_name=clean_price_laptop["brand_name"],
        hover_data=clean_price_laptop,
        symbol=clean_price_laptop["brand_name"],
        size=clean_price_laptop["brand_name"],
    )
